...
data_root = 'data/view0_lh_pt/videos_train'
data_root_val = 'data/view0_lh_pt/videos_val'
ann_file_train = 'data/view0_lh_pt/view0_lh_pt_train_list_videos.txt'
ann_file_val = 'data/view0_lh_pt/view0_lh_pt_val_list_videos.txt'
ann_file_test = 'data/view0_lh_pt/view0_lh_pt_val_list_videos.txt'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        num_repeats=2,
        ann_file='data/view0_lh_pt/view0_lh_pt_train_list_videos.txt',
        data_prefix=dict(video='data/view0_lh_pt/videos_train'),
        pipeline=[
            dict(type='DecordInit', io_backend='disk'),
            dict(
                type='SampleFrames',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='VideoDataset',
        ann_file='data/view0_lh_pt/view0_lh_pt_val_list_videos.txt',
        data_prefix=dict(video='data/view0_lh_pt/videos_val'),
        pipeline=[
            dict(type='DecordInit', io_backend='disk'),
            dict(
                type='SampleFrames',
...
launcher = 'none'
work_dir = './work_dirs/mvit-small-p244_32xb16-16x4x1-200e_view0_lh_pt'
