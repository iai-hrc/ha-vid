...
class Graph():
    ...
    def get_edge(self, layout):
        ...
        if layout == 'openpose':
            ...
            self.edge = self_link + neighbor_link
            self.center = 0
        elif layout == 'azure_full':
            self.num_node = 32
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_1base = [(2, 1), (21, 2), (27, 21), (3, 21), (26, 21),
                              (5, 26), (6, 5), (7, 6), (8, 7), (23, 7), (22, 8),
                              (9, 27), (10, 9), (11, 10), (12, 11), (25, 11), (24, 12),
                              (13, 1), (14, 13), (15, 14), (16, 15),
                              (17, 1), (18, 17), (19, 18), (20, 19),
                              (4, 3), (28, 4), (31, 28), (32, 31), (29, 28), (30, 29)]
            neighbor_link = [(i - 1, j - 1) for (i, j) in neighbor_1base]
            self.edge = self_link + neighbor_link
            self.center = 1
        elif layout == 'azure_upper':
            self.num_node = 26
            self_link = [(i, i) for i in range(self.num_node)]
            neighbor_1base = [(2, 1), (15, 2), (21, 15), (3, 15), (20, 15), (14, 1), (13, 1),
                              (5, 20), (6, 5), (7, 6), (8, 7), (17, 7), (16, 8),
                              (9, 21), (10, 9), (11, 10), (12, 11), (19, 11), (18, 12),
                              (4, 3), (22, 4), (23, 22), (24, 23), (25, 22), (26, 25)]
            neighbor_link = [(i - 1, j - 1) for (i, j) in neighbor_1base]
            self.edge = self_link + neighbor_link
            self.center = 1
        else:
